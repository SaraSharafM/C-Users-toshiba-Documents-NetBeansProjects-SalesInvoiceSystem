...
public class Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.getSelectionModel().addListSelectionListener(handler);
...
private ArrayList<InvoiceHeads> invoices;
...
private RightTable rightTable;
    ...
    public ArrayList<InvoiceHeads> getInvoices() {
        return invoices;
    }

    public void setInvoices(ArrayList<InvoiceHeads> invoices) {
    ...
    public ActiveHandler getHandler() {
        return handler;
    }
public int getNextInvoiceNum(){
int num=0;
for(InvoiceHeads invoice:invoices){
...
ActiveHandler handler=new ActiveHandler(this);
